		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX400문제",
									"targetURL": "#sapbtpux400solvinge07-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpux400solvinge07-display": {
								"semanticObject": "sapbtpux400solvinge07",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.ux400solvinge07",
									"url": sap.ui.require.toUrl("sap/btp/ux400solvinge07")
								}
							}
						}
					}
