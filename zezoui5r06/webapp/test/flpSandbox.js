			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zezoui5r06-display": {
								"semanticObject": "zezoui5r06",
								"action": "display",
								"description": "공장스케쥴 예약정보",
								"title": "공장스케쥴 예약정보",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zezoui5r06",
									"url": sap.ui.require.toUrl("zezoui5r06")
								}
							}
						}
					}
