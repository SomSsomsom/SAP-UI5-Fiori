		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX410 문제",
									"targetURL": "#sapbtpux410solvinge07-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpux410solvinge07-display": {
								"semanticObject": "sapbtpux410solvinge07",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.ux410solvinge07",
									"url": sap.ui.require.toUrl("sap/btp/ux410solvinge07")
								}
							}
						}
					}
