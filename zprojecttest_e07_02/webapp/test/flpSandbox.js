		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#C05zprojectteste0702-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"C05zprojectteste0702-display": {
								"semanticObject": "C05zprojectteste0702",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=C05.zprojectteste0702",
									"url": sap.ui.require.toUrl("C05/zprojectteste0702")
								}
							}
						}
					}
