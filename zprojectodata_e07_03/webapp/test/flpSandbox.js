		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind",
									"targetURL": "#NTzprojectodatae0703-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"NTzprojectodatae0703-display": {
								"semanticObject": "NTzprojectodatae0703",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=NT.zprojectodatae0703",
									"url": sap.ui.require.toUrl("NT/zprojectodatae0703")
								}
							}
						}
					}
