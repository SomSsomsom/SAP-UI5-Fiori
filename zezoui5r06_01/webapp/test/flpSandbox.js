		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "공장스케쥴 예약 정보",
									"targetURL": "#zezoui5r0601-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zezoui5r0601-display": {
								"semanticObject": "zezoui5r0601",
								"action": "display",
								"description": "공장스케쥴 예약 정보",
								"title": "공장스케쥴 예약 정보",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zezoui5r0601",
									"url": sap.ui.require.toUrl("zezoui5r0601")
								}
							}
						}
					}
